...
//공통모듈 : 여러 클래스가 공통으로 이용할 코드 작성용 클래스
//데이터베이스 연결에 대한 Connection 관리와 트랜잭션 관리용 기능 제공
//싱글톤 패턴 적용 : 프로그램 구동내내 메모리에 딱 1번, 1개만 기록해서  
...
//					"jdbc:oracle:thin:@127.0.0.1:1521:xe", 	//localhost = 127.0.0.1
//					"c##student", "c##student");
...
//	}
	...
	public static Connection getConnection() {		
		...
		try {
			// 현재 구동중인 웹애플리케이션에서 특정 폴더 안의 파일을 읽으려면,
			// 폴더 지정부터 해야 함.
